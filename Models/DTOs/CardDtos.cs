...
public record CardDetailDto(Guid Id, Guid ListId, string Title, string? Description, int Position, DateTime? DueDate, bool IsArchived, Guid CreatedById, List<CardMemberDto> Members, List<LabelDto> Labels, List<CommentDto> Comments, List<ChecklistDto> Checklists, DateTime CreatedAt, DateTime UpdatedAt);
